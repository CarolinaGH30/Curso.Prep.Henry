...
function conection(status) {
  ...
  if (status === 2) return "Away"; else return "Offline"
...
function saludo(idioma) {
 ...
 if (idioma !== "aleman" || "mandarin" || "ingles" || "undefined") return "Hola!";
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1=== 0 || num2===0 || num3===0) return  "Error"; else return "false;"
}
...
function esPrimo(numero) {
  ...
  // Nota: Los números 0 y 1 NO son considerados números
...
function tablaDelSeis(){
  ...
  let arrayTablaDel6 = [] 
  for (let i = 0; i < 11; i++) 
   arrayTablaDel6.push(6 * i); return arrayTablaDel6
}
